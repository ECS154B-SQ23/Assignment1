...
class ALUControlUnitRTypeTester(c: ALUControl) extends PeekPokeTester(c) {
  ...
  val tests = List(
    ...
    (       1.U, "b0000000".U, "b000".U, "b00000".U, "add"),
    (       1.U, "b0100000".U, "b000".U, "b00010".U, "sub"),
    (       1.U, "b0000000".U, "b001".U, "b10010".U, "sll"),
    (       1.U, "b0000000".U, "b010".U, "b10110".U, "slt"),
    (       1.U, "b0000000".U, "b011".U, "b10111".U, "sltu"),
    (       1.U, "b0000000".U, "b100".U, "b01111".U, "xor"),
    (       1.U, "b0000000".U, "b101".U, "b10100".U, "srl"),
    (       1.U, "b0100000".U, "b101".U, "b10000".U, "sra"),
    ...
    (       1.U, "b0000001".U, "b101".U, "b01010".U, "divu"),
    (       1.U, "b0000001".U, "b110".U, "b11100".U, "rem"),
    (       1.U, "b0000001".U, "b111".U, "b11011".U, "remu"),
    (       3.U, "b0000000".U, "b000".U, "b00001".U, "addw"),
    (       3.U, "b0100000".U, "b000".U, "b00100".U, "subw"),
    (       3.U, "b0000000".U, "b001".U, "b10011".U, "sllw"),
    (       3.U, "b0000000".U, "b101".U, "b10101".U, "srlw"),
    (       3.U, "b0100000".U, "b101".U, "b10001".U, "sraw"),
    (       3.U, "b0000001".U, "b000".U, "b00110".U, "mulw"),
    (       3.U, "b0000001".U, "b100".U, "b01011".U, "divw"),
    (       3.U, "b0000001".U, "b101".U, "b01100".U, "divuw"),
    (       3.U, "b0000001".U, "b110".U, "b11010".U, "remw"),
    (       3.U, "b0000001".U, "b111".U, "b11001".U, "remuw"),
  )
